...
export default async function Page({params}: any) {
    ...
    const metadata: Metadata = {
        ...
        openGraph: {
            ...
            images: [
                {
                    url: apartment?.images && apartment?.images[0]?.preview_url || defaultImage, // Set a default image if not provided
                    width: 800,
                    height: 600,
        ...
        twitter: {
            ...
            images: [
                {
                    url: apartment?.images && apartment?.images[0]?.preview_url || defaultImage, // Correctly use `images` here
                    width: 800,
                    height: 600,
                    alt: apartment?.title || "Apartment Image",
                    type: 'image/png',
