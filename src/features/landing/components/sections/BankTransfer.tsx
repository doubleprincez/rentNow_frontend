    ...
    return <>
        <div className=" mt-20 w-full md:w-3/4 border border-gray-300 min-h-[300px] p-3">
            ...
            <div>
                ...
                {
                    loading ? <div className="min-h-[300px] flex justify-center items-center"><LucideLoader2
                        ...
                        subscription ? showSubscriptionDetails() : <div className="space-y-3">
                            ...
                            <p>
                                <label>Plan
                                    Amount: <span>{plan?.currency}{formatAmountNumber(plan?.price)}</span></label>
                            </p>
                            <p>
                            ...
                            <div className="pt-[126px]">
                                <Button disabled={loading} className="bg-green-500 hover:bg-green-600  text-gray-100"
                                        onClick={() => generateSubscription()}>Pay Now</Button>
                            </div>
