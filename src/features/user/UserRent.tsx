                                    ...
                                    visits.map((visit: any, i: number) => (
                                        <TableRow key={i}>
                                            ...
                                            <TableCell>{new Date(visit.visit_date).toDateString()}
                                                <br/> {new Date(visit?.visit_date).toDateString()}</TableCell>
                                            <TableCell> {visit?.apartment?.user?.business_name||visit?.apartment?.user?.name} </TableCell>
