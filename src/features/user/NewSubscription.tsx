...
const NewSubscription =()=>{
    ...
    return <div className="relative text-gray-300" id="pricing">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
                <div
                    ...
                    <p className="text-center mb-6">Get access to all premium features for just $199 per month. No hidden fees or extra
                        charges.</p>
                    <a target="_blank" rel="noreferrer"
                       ...
                       href="#contact"><span className="relative text-sm font-semibold text-black">Get Started</span></a>
                </div>
            </div>
        </div>
    </div>
