                            ...
                            <div key={index} className="grid grid-cols-3 gap-2 items-center">
                                ...
                                <div>
                                    <Button variant="destructive"
                                            className="p-1 bg-red-700 hover:bg-red-800 text-white text-xs my-2"
...
const PlanList = () => {
    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
                ...
                <Table>
                    ...
                    <TableBody>
                        {loading ? (
                            ...
                            plans?.map((plan) => (
                                <PlanTableRow key={plan.id} plan={plan} onEdit={openEditForm}
            ...
            <PlanForm isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} onSave={handleSavePlan}
