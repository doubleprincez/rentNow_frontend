    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
            <div>
                ...
                {
                    selectedTransaction ?
                        <AdminTransaction closeSelected={() => {
    ...
    return (
        <div className="p-4 border rounded shadow bg-white">
            ...
            <p><strong>Status:</strong> <span
                className={`text-${status === "verified" ? "green" : "red"}-600`}>{status}</span></p>
            ...
            {transaction && transaction.payable?.proof_of_payment && (
                <Dialog>
                    <DialogTrigger asChild>
                        <button className="mt-2 px-2 py-1 bg-gray-200 hover:bg-gray-300 rounded text-sm">View Proof
                        </button>
                    </DialogTrigger>
                    <DialogContent>
                        <DialogHeader>
            ...
            <div className="  flex space-x-2 mt-10">
                <Button onClick={() => updateTransactionStatus("confirmed")}
                        disabled={loading || status === "confirmed"}
                        className="bg-green-500 hover:bg-green-600 text-white">Confirm</Button>
                <Button onClick={() => updateTransactionStatus("denied")} disabled={loading || status === "denied"}
                        className="bg-red-500 hover:bg-red-600 text-white">Decline</Button>
            </div>
            <div>
