...
import {deleteUser, getUsers, User} from '../api/userApi';
                                                    ...
                                                    {selectedUser && (
                                                        <div className="grid gap-4">
                                                            <div>
                                                                ...
                                                                <p>Email: <a className={"text-red-300"}
                                                                             href={"mailto:" + selectedUser?.email}>{selectedUser.email}</a>
                                                                </p>
                                                                <p>Phone: <a className={"text-red-300"}
                                                                             href={"tel:" + selectedUser?.phone}>{selectedUser.phone || 'N/A'}</a>
                                                                </p>
                                                            </div>
                                                            <div>
